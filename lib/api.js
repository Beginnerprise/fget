...
var api = {
  ...
  get: function(options, callback) {
    ...
    var _request = request.head(options, function(err, response, body) {
      ...
      _filename = decodeURI(response.request.uri.pathname.split('/').pop());
      ...
      return fs.open(_tmpFileName, 'w', function(err, fd) {
        ...
        return fs.truncate(fd, _totalSizeOfFile, function() {
           ...
           */
          var _doHandleDownloadChunkDone = function(err, file) {
            _chunksCompleted++;
            if (err) {
              throw new Error(err);
            }
...
if (module.parent === null) {
  ...
  var options = {
    uri: "https://s3.amazonaws.com/test_starphleet/starphleetVM.tar"
      // uri: "https://fbstatic-a.akamaihd.net/rsrc.php/v2/yk/r/b-v2dB77ckg.css"
      // uri: "https://s3-us-west-2.amazonaws.com/glg-webdialer-oregon/bower_components/core-a11y-keys/core-a11y-keys.html"
  };
